...
export const StickerContext =
    createContext<StickerContextValue | null>(
        null
    );
    ...
    const replaceCollection =
        useCallback(
            async (
                ...
                await persistCollection(
                    nextCollection,
                    'Your imported collection could not be saved.'
                );
            },
            [persistCollection]
        );
